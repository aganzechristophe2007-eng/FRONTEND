...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white flex flex-col justify-between px-5 py-6 sm:px-8 md:p-16 relative overflow-x-hidden text-center">
      <div className="absolute left-1/2 -translate-x-1/2 w-[350px] md:w-[500px] h-[350px] md:h-[500px] bg-orange-600/10 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="flex justify-between items-center z-10 max-w-2xl w-full mx-auto">
        {step !== 'welcome' || isForgotPassword ? (
          <button 
            ...
            className="text-neutral-400 hover:text-white text-xs font-medium flex items-center gap-2 transition cursor-pointer py-2 mx-auto sm:mx-0"
          >
            <ArrowLeft className="w-4 h-4" /> Retour
          </button>
        ) : (
          <Link to="/" className="text-neutral-500 hover:text-neutral-300 text-xs font-medium transition py-2 mx-auto sm:mx-0">
            ← Accueil
          </Link>
        )}
      </div>
      ...
      >
        <div className="w-full flex flex-col items-center">
          {error && (
            <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="mb-5 p-3.5 rounded-xl bg-red-500/10 border border-red-500/20 text-red-400 text-xs flex items-center justify-center gap-3 w-full">
          ...
          {successMsg && (
            <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="mb-5 p-3.5 rounded-xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-xs flex items-center justify-center gap-3 w-full">
          ...
          <AnimatePresence mode="wait">
            {isForgotPassword ? (
              <motion.div key="forgot" initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -15 }} className="space-y-5 w-full flex flex-col items-center">
                <h1 className="text-2xl sm:text-3xl md:text-5xl font-extrabold tracking-tight leading-tight text-center">
                ...
                <form onSubmit={handleForgotPasswordSubmit} className="space-y-5 w-full max-w-md">
                  {forgotStep === 'request' && (
                    <div className="relative w-full">
                      ...
                      <input 
                        ...
                        className="w-full bg-neutral-900 border border-neutral-800 rounded-xl pl-11 pr-4 py-3.5 text-white placeholder-neutral-600 focus:outline-none focus:border-orange-500 text-sm sm:text-base transition text-center"
                      />
                    </div>
                  )}
                  ...
                  {forgotStep === 'reset' && (
                    <div className="relative w-full">
                      ...
                      <input 
                        ...
                        className="w-full bg-neutral-900 border border-neutral-800 rounded-xl pl-11 pr-12 py-3.5 text-white placeholder-neutral-600 focus:outline-none focus:border-orange-500 text-sm sm:text-base transition text-center"
                      />
              ...
              <>
                {step === 'welcome' && (
                  <motion.div key="welcome" initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -15 }} className="space-y-6 sm:space-y-8 w-full flex flex-col items-center">
                    <h1 className="text-2xl sm:text-4xl md:text-5xl font-extrabold tracking-tight leading-tight text-center">
                      Bienvenue sur notre site.
                    </h1>
                    <p className="text-neutral-400 text-xs sm:text-sm md:text-base font-light text-center">
                      Commençons par faire connaissance. Êtes-vous ici pour la toute première fois ?
                    </p>
                    <div className="flex flex-col gap-3.5 pt-1 w-full max-w-md">
                      <button
                        onClick={() => { setIsFirstTime(true); setStep('intent'); }}
                        className="py-3.5 sm:py-4 px-4 sm:px-5 rounded-2xl text-sm sm:text-base md:text-lg font-semibold text-white transition flex items-center justify-center gap-3 group cursor-pointer border border-neutral-800 hover:border-orange-500 bg-neutral-900/60 hover:bg-neutral-900"
                      >
                      ...
                      <button
                        ...
                        className="py-3.5 sm:py-4 px-4 sm:px-5 rounded-2xl text-sm sm:text-base md:text-lg font-semibold text-neutral-300 transition flex items-center justify-center gap-3 group cursor-pointer border border-neutral-800 hover:border-neutral-500 bg-neutral-900/60 hover:bg-neutral-900"
                      >
                ...
                {step === 'intent' && (
                  <motion.div key="intent" initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -15 }} className="space-y-6 sm:space-y-8 w-full flex flex-col items-center">
                    <h1 className="text-2xl sm:text-4xl md:text-5xl font-extrabold tracking-tight leading-tight text-center">
                      {isFirstTime ? "Comment souhaitez-vous créer votre compte ?" : "Comment souhaitez-vous vous connecter ?"}
                    </h1>
                    
                    <div className="space-y-3 pt-1 w-full max-w-md">
                      <button
                        onClick={() => handleSocialLogin('google')}
                        className="w-full py-3.5 sm:py-4 px-4 sm:px-5 rounded-2xl text-sm sm:text-base font-medium text-white transition flex items-center justify-between border border-neutral-800 hover:border-orange-500 bg-neutral-900/60 hover:bg-neutral-900 cursor-pointer group"
                      >
                      ...
                      <button
                        ...
                        className="w-full py-3.5 sm:py-4 px-4 sm:px-5 rounded-2xl text-sm sm:text-base font-medium text-white transition flex items-center justify-between border border-neutral-800 hover:border-blue-500 bg-neutral-900/60 hover:bg-neutral-900 cursor-pointer group"
                      >
                        <div className="flex items-center gap-3 mx-auto">
                      ...
                      <button
                        ...
                        className="w-full py-3.5 sm:py-4 px-4 sm:px-5 rounded-2xl text-sm sm:text-base font-medium text-white transition flex items-center justify-center gap-3 border border-neutral-800 hover:border-orange-500 bg-neutral-900/60 hover:bg-neutral-900 cursor-pointer group"
                      >
                ...
                {step === 'referral' && (
                  <motion.div key="referral" initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -15 }} className="space-y-5 w-full flex flex-col items-center">
                    <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-center">Comment avez-vous connu CBFSOKO ?</h1>
                    <p className="text-neutral-400 text-xs text-center">Sélectionnez l'option qui correspond le mieux.</p>
                    
                    <div className="space-y-2.5 pt-1 w-full max-w-md">
                      {referralOptions.map((opt) => {
                        ...
                        return (
                          <button
                            ...
                            className={`w-full py-3 px-4 rounded-xl text-xs sm:text-sm font-medium transition flex items-center justify-between border cursor-pointer ${
                              isSelected 
                                ? 'border-orange-500 bg-orange-500/10 text-orange-400' 
                                : 'border-neutral-800 bg-neutral-900/60 text-white hover:border-orange-500/50'
                            }`}
                          >
                            <div className="flex items-center gap-3 truncate mx-auto">
                ...
                {step === 'name' && (
                  <motion.div key="name" initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -15 }} className="space-y-5 w-full flex flex-col items-center">
                    <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-center">Quel est votre nom complet ?</h1>
                    <form onSubmit={(e) => { e.preventDefault(); if (name.trim()) setStep('phone'); }} className="space-y-5 w-full max-w-md flex flex-col items-center">
                      <div className="relative w-full">
                ...
                {step === 'phone' && (
                  <motion.div key="phone" initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -15 }} className="space-y-5 w-full flex flex-col items-center">
                    <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-center">Quel est votre numéro de téléphone ?</h1>
                    <p className="text-neutral-400 text-xs text-center">Nécessaire pour vos livraisons et communications.</p>
                    <form onSubmit={(e) => { e.preventDefault(); if (phone.trim()) setStep('email'); }} className="space-y-5 w-full max-w-md flex flex-col items-center">
                      <div className="relative w-full">
                ...
                {step === 'email' && (
                  <motion.div key="email" initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -15 }} className="space-y-5 w-full flex flex-col items-center">
                    <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-center">Quelle est votre adresse email ?</h1>
                    <form onSubmit={(e) => { e.preventDefault(); if (email.trim()) setStep('password'); }} className="space-y-5 w-full max-w-md flex flex-col items-center">
                      <div className="relative w-full">
                        <Mail className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-neutral-500" />
                        <input 
                          type="email" autoFocus required value={email} onChange={e => setEmail(e.target.value)}
                ...
                {step === 'password' && (
                  <motion.div key="password" initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -15 }} className="space-y-5 w-full flex flex-col items-center">
                    <div className="flex flex-col sm:flex-row justify-center items-center gap-2 w-full">
                      <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-center">
                    ...
                    {!isFirstTime && (
                      <button 
                        ...
                        className="text-xs text-orange-500 hover:underline cursor-pointer font-semibold block mx-auto"
                      >
                        Mot de passe oublié ?
                      </button>
                    )}

                    <form onSubmit={handleFinalSubmit} className="space-y-5 w-full max-w-md">
                      <div className="relative w-full">
                        <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-neutral-500" />
                        <input 
      ...
      <div className="z-10 max-w-2xl w-full mx-auto text-neutral-600 text-[11px] flex flex-col sm:flex-row justify-between items-center pt-4 gap-2">
